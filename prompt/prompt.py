members_dict = {'information_node':'specialized agent to provide information related to availability or any FAQs.','booking_node':'specialized agent to only to book, cancel or reschedule appointment'}
